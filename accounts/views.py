from .verify import sentOTP
from .verify import checkOTP
...
def signin_otp(request):
    ...
    return render(request, "accounts/mobile.html")
...
def change_password(request):
    if request.method == 'POST':
        ...
        if new_password == confirm_password:
            ...
            if success:
                user.set_password(new_password)#set_password is django inbuilt function
                user.save()
                # auth.logout(request)
